...
/** Scoring sheet card header with title, subtitle, and optional reset button */
export default function ScoringSheetHeader({
  ...
  return (
    <div className="p-3 border-b border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-900 flex items-start justify-between">
      <div>
        <h3 className="text-sm font-bold text-gray-700 dark:text-gray-300">{title ?? t('scoring.sheetTitle')}</h3>
