...
- **Action Steel** — časové vstupy pre každú strunu vľavo, hit tap mriežka vpravo.
- **Multi-Gun** — jeden čas vľavo, prepínače neutralizácie pre každý terč vpravo.
- **Bullseye / ISSF / Archery** — tlačidlá skóre v kruhoch pre každý výstrel.
- **NRL22 / Long Range (PRS)** — hit prepínač na každom terči, bez času.

## Uloženie

Kliknutím na **Uložiť** zapíšete skóre. Riadok strelca dostane zelené zaškrtnutie a automaticky sa vyberie ďalší strelec. Na manuálny presun použite **Ďalej** / **Späť** v hlavičke.

## Súhrnné zobrazenie (vzdialení zadávači)

Ne-administratívny zadávač vidí po zadaní zásahov **súhrnné zobrazenie** — skontroluje vstupy a klikne na **Potvrdiť** pre odoslanie. Hostiteľ potom prijme alebo zamietne zo svojho zariadenia.
