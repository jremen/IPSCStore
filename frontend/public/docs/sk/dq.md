...
V hárku zadávania prejdite naspodku a kliknite na tlačidlo **DQ**.

![Potvrdzovací modal DQ](/docs/screenshots/dq-confirm-modal.png)

Vyberte dôvod z rozbaľovacieho zoznamu a potvrďte. Riadok strelca v tabuľke registrácie sčervená a dostane badge „DQ". Ak to chcete vrátiť späť, kliknite na **Zrušiť DQ** na rovnakom mieste v hárku zadávania.

## Preddefinované dôvody

DQ modal ponúka zoznam preddefinovaných dôvodov (porušenia pravidiel, bezpečnosť atď.). Uložená hodnota je preložený text vybraného dôvodu, ktorý sa zobrazuje všade, kde sa DQ odkazuje.
